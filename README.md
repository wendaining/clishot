...
<img src="./docs/img/clishot-logo.png" alt="logo" style="zoom:30%">
...
<img src="./docs/img/tmp-pwsh-no-controls.png" style="zoom:33%;" />

<img src="./docs/img/tmp-wsl-ohmyzsh-trimmed.png" style="zoom:33%;" />
